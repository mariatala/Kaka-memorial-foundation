			...
			<div className="w-full min-w-48 inline-flex flex-col md:flex-row justify-evenly items-start gap-8">
				...
				<div className="w-full h-full md:w-1/2 xl:w-1/3 py-4 sm:py-8 inline-flex flex-col justify-start items-center gap-6">
					...
					<Link
						...
						className={`px-8 py-2.5 border-2 border-primary text-primary font-semibold rounded-sm hover:bg-primary hover:text-light transition-all duration-300 tracking-wider text-sm uppercase ${inter.className}`}
					>
						Join the Mission
					</Link>
				</div>
