...
export default async function AdminMessagesPage() {
    ...
    if (!session?.user || session.user.role !== 'admin') {
        redirect('/sign-in?callbackUrl=/admin/messages');
    }
            ...
            <div className="w-full bg-primary pt-24 pb-16 px-6 md:px-16">
                <div className="max-w-5xl mx-auto">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-accent-one/20 flex items-center justify-center shrink-0">
                            <MessageSquare size={20} className="text-accent-one" />
                        </div>
                        <div>
