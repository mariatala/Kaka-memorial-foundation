...
import EventsSkeleton from '@/app/events/EventsSkeleton';
	...
	return (
		<div className="w-full h-full flex flex-col bg-light text-primary">
			<section className="w-full flex min-h-128 md:min-h-120 justify-start items-center py-8 md:py-0">
				<div className="w-full flex flex-col-reverse md:flex-row mt-16 justify-end items-center animate-fade-in">
			...
			{/* EventsSection streamed in — skeleton shown while DB query runs */}
